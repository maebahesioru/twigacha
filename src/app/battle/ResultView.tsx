        ...
        {questStage ? (
          ...
          <>
            ...
            <div className="grid grid-cols-5 gap-2 w-full max-w-2xl">
              ...
              <button onClick={() => { window.open(`https://donshare.net/share.html?text=${encodeURIComponent(copyText)}&url=${encodeURIComponent("https://twigacha.vercel.app")}`, "_blank"); markShare(); }} className="px-3 py-2 text-sm bg-indigo-600 rounded-xl font-bold hover:bg-indigo-500 transition">Mastodon</button>
